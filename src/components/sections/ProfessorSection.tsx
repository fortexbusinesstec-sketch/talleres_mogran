  ...
  return (
    ...
    >
      <div className="container-section">
        <h2
          id="professor-title"
          className="text-3xl md:text-4xl lg:text-5xl font-bold text-mogran-dark-text text-center mb-16 text-balance max-w-3xl mx-auto"
        >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div>
            <h3 className="text-2xl md:text-3xl font-bold text-mogran-dark-text mb-4">
              {profesor.nombre}
            </h3>
            <p className="text-mogran-dark-text-muted mb-6">
              Comunicador, locutor y formador
            </p>
            <div className="space-y-4 text-mogran-dark-text-secondary leading-relaxed">
              <p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-6 text-mogran-accent hover:text-mogran-cyan transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-mogran-accent rounded-md p-1"
            >
        ...
        <div>
          <h3 className="text-xl md:text-2xl font-semibold text-mogran-dark-text mb-8 text-center">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-mogran-accent/20 shadow-xl bg-mogran-dark-elevated h-full">
              <VideoPlayer
