  ...
  return (
    ...
    >
      <div className="container-section">
        ...
        <div className="bg-white/5 rounded-3xl p-8 md:p-12 lg:p-16 text-center max-w-4xl mx-auto border border-white/10">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-6 text-balance">
